...
public:
    ...
    virtual void output(const T* const source) override {
        ...
        if (osMessageQueuePut(this->getQueueHandle(), source, 0, 0) != osOK) {
            ...
            osMessageQueueGet(this->getQueueHandle(), &dummy, NULL, 0);
            ...
            osMessageQueuePut(this->getQueueHandle(), source, 0, 0);
        }
    }
