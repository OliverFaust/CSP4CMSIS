...
APPL_DEFINES += -DCSP4CMSIS_AI_TESTBENCH
...
##
LIB_SEL = pwrmgmt sensordp tflmtag2412_u55tag2411 spi_ptl spi_eeprom i2c_comm
LIB_SEL += csp4cmsis
##
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_AI_testbench.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_AI_testbench.ld
endif
