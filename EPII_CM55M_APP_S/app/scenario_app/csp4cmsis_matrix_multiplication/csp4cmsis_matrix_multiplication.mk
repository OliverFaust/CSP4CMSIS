...
APPL_DEFINES += -DCSP4CMSIS_MATRIX_MULTIPLICATION
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_matrix_multiplication.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_matrix_multiplication.ld
endif
