...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_matrix_multiplication
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_MATRIX_MULTIPLICATION
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_matrix_multiplication.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_matrix_multiplication.ld
endif
