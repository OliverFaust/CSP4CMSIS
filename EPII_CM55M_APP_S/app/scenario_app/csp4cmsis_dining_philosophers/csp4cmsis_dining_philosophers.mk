...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_dining_philosophers
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_DINING_PHILOSOPHERS
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_dining_philosophers.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_dining_philosophers.ld
endif
