...
APPL_DEFINES += -DCSP4CMSIS_DINING_PHILOSOPHERS
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_dining_philosophers.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_dining_philosophers.ld
endif
