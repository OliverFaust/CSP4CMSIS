...
APPL_DEFINES += -DCSP4CMSIS_KWS_PCA9685#-DTFLM_NOTZ
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_PCA9685.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_PCA9685.ld
endif
