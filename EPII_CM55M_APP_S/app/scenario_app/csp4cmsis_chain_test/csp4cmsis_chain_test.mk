...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_chain_test
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_CHAIN_TEST
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_chain_test.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_chain_test.ld
endif
