...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_irq
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_IRQ
...
APP_SCENARIO_CONTENTS_INCDIR += $(BASE_DIR)/external/cis
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_irq.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_irq.ld
endif
