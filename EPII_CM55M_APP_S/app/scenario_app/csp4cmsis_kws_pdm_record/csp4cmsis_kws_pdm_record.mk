...
APPL_DEFINES += -DCSP4CMSIS_KWS_PDM_RECORD#-DTFLM_NOTZ
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_pdm_record.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_pdm_record.ld
endif
