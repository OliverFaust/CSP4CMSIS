...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_alt_test_max
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_ALT_TEST_MAX
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_alt_test_max.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_alt_test_max.ld
endif
