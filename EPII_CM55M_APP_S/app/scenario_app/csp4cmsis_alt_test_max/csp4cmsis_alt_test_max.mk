...
APPL_DEFINES += -DCSP4CMSIS_ALT_TEST_MAX
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_alt_test_max.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_alt_test_max.ld
endif
