...
CURR_PROJ_DIR := ./app/scenario_app/csp4cmsis_asymmetric_philosophers
...
# 4. COMPILER DEFINES
# -------------------------------------------------------------------------
override APPL_DEFINES += -DCSP4CMSIS_ASYMETRIC_PHILOSOPHERS
...
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_asymmetric_philosophers.sct
else
override LINKER_SCRIPT_FILE := $(CURR_PROJ_DIR)/csp4cmsis_asymmetric_philosophers.ld
endif
