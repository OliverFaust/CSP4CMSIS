...
APPL_DEFINES += -DCSP4CMSIS_ASYMETRIC_PHILOSOPHERS
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_asymmetric_philosophers.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_asymmetric_philosophers.ld
endif
