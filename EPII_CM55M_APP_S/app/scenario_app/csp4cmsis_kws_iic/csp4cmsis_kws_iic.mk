...
APPL_DEFINES += -DCSP4CMSIS_KWS_IIC#-DTFLM_NOTZ
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_iic.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_kws_iic.ld
endif
