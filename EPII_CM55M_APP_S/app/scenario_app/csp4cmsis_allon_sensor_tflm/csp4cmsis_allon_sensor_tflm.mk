...
APPL_DEFINES += -DCSP4CMSIS_ALLON_SENSOR_TFLM
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_allon_sensor_tflm.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/csp4cmsis_allon_sensor_tflm.ld
endif
