...
ifdef LIB_SEL
	...
	# Generate relative paths for the .mk files
	...
	# Collect all valid .mk files using absolute-style paths to ensure wildcard resolution
	LIB_INCLUDES = $(foreach LIB_MK, $(LIB_MKS), $(wildcard $(LIBRARIES_ROOT)/$(LIB_MK)))
	LIB_INCLUDES += $(foreach LIB_CV_MK, $(LIB_CV_MKS), $(wildcard $(LIBRARIES_ROOT)/$(LIB_CV_MK)))
	LIB_INCLUDES += $(foreach LIB_AUDIO_ALGO_MK, $(LIB_AUDIO_ALGO_MKS), $(wildcard $(LIBRARIES_ROOT)/$(LIB_AUDIO_ALGO_MK)))
